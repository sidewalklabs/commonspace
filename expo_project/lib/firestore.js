  ...
  return (function(t) {
        ...
        (t.exports = function(t, n, r, c) {
          ...
          a && (o(r, 'name') || i(r, 'name', n)),
            t[n] !== r &&
              ...
              t === e
                ? (t[n] = r)
                : c ? (t[n] ? (t[n] = r) : i(t, n, r)) : (delete t[n], i(t, n, r)));
      ...
      if (r(6)) {
        var e = r(30),
          ...
          At = function(t) {
            ...
            for (
              l && f > 2 && (s = a(s, arguments[2], 2)), n = 0, r = d(c.length), i = Pt(this, r);
              r > n;
              n++
            )
              i[n] = l ? s(c[n], n) : c[n];
        ...
        mt || ((G.f = Ct), (C.f = Gt)),
          u(u.S + u.F * !mt, 'Object', { getOwnPropertyDescriptor: Ct, defineProperty: Gt }),
          o(function() {
            ht.call({});
          }) &&
            (ht = vt = function() {
          ...
          (t.exports = function(t, n, r, f) {
            ...
            b
              ? ((p = r(function(t, r, e, i) {
                  ...
                  if (w(r)) {
                    if (
                      !(r instanceof K || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)
                    )
              ...
              : (o(function() {
                ...
                ((p = r(function(t, r, e, i) {
                  ...
                  return (
                    s(t, p, a),
                    w(r)
                      ? r instanceof K || 'ArrayBuffer' == (o = S(r)) || 'SharedArrayBuffer' == o
                        ? void 0 !== i
                          ? new g(r, Et(e, n), i)
                          : void 0 !== e ? new g(r, Et(e, n)) : new g(r)
                        : bt in r ? Ft(p, r) : At.call(p, r)
                      : new g(y(r))
                  );
                })),
        ...
        return void 0 === t
          ...
          : null === t
            ...
            : 'string' ==
              ...
              : o
                ? e(n)
                : 'Object' == (u = e(n)) && 'function' == typeof n.callee ? 'Arguments' : u;
      };
    },
    function(t, n, r) {
      var e = r(18),
    ...
    function(t, n, r) {
      ...
      t.exports = function(t, n, r, p, d, y, g) {
        ...
        if (
          ...
          if (((m = { values: _ ? M : w('values'), keys: y ? M : w('keys'), entries: F }), g))
    ...
    function(t, n, r) {
      ...
      function k(t, n, r) {
        ...
        for (
          (t = P(t)) != t || t === E
            ...
            : ((e = F(j(t) / A)),
              t * (o = M(2, -e)) < 1 && (e--, (o *= 2)),
              (t += e + a >= 1 ? s / o : s * M(2, 1 - a)) * o >= 2 && (e++, (o /= 2)),
              e + a >= f
                ? ((i = 0), (e = f))
                : e + a >= 1
                  ? ((i = (t * o - 1) * M(2, n)), (e += a))
      ...
      function z(t, n, r, e, i, o) {
        ...
        for (var c = t[I]._b, f = u + t[R], a = e(+i), s = 0; s < n; s++)
          c[f + s] = a[o ? s : n - s - 1];
      }
      if (u.ABV) {
        if (
        ...
        function(t) {
          ...
          return i < f
            ? a *
                ...
                f *
                u
            : (r = (n = (1 + u / o) * i) - (n - i)) > c || r != r ? a * (1 / 0) : a * r;
        };
    },
    function(t, n, r) {
      var e = r(1);
    ...
    function(t, n, r) {
      ...
      var e,
        ...
        m = (t.exports = r(59)('WeakMap', y, g, f, !0, !0));
      s(function() {
    ...
    function(t, n, r) {
      'use strict';
      if ((r(128), r(325), r(326), global._babelPolyfill))
    ...
    function(t, n, r) {
      ...
      var e = r(2),
        ...
        K = function(t, n, r) {
          return (
            ...
            i(W, n)
              ? (r.enumerable
                  ? (i(t, k) && t[k][n] && (t[k][n] = !1), (r = _(r, { enumerable: x(0, !1) })))
                  : (i(t, k) || j(t, k, x(1, {})), (t[k][n] = !0)),
                z(t, n, r))
              : j(t, n, r)
          );
        },
        q = function(t, n) {
          m(t);
          for (var r, e = y((n = S(n))), i = 0, o = e.length; o > i; ) K(t, (r = e[i++]), n[r]);
          return t;
        },
        H = function(t) {
        ...
        Z = function(t) {
          for (var n, r = t === G, e = A(r ? C : S(t)), o = [], u = 0; e.length > u; )
      ...
      u(u.S + u.F * !U, 'Symbol', {
        ...
        I.prototype[T] || r(11)(I.prototype, T, I.prototype.valueOf),
        l(I, 'Symbol'),
        l(Math, 'Math', !0),
        l(e.JSON, 'JSON', !0);
    },
        ...
        'Array',
        {
          from: function(t) {
            ...
            if (
              ...
              for (r = new v((n = f(h.length))); n > g; g++) a(r, g, y ? d(h[g], g) : h[g]);
            else
      ...
      r(56)('split', 2, function(t, n, e) {
        ...
        if (
          ...
          e = function(t, n) {
            ...
            return (
              p === r.length ? (!s && y.test('')) || h.push('') : h.push(r.slice(p)),
      ...
      u(u.S, 'Reflect', {
        get: function t(n, r) {
          ...
          return f(n) === s
            ? n[r]
            : (u = e.f(n, r))
              ? o(u, 'value') ? u.value : void 0 !== u.get ? u.get.call(s) : void 0
              : c((a = i(n))) ? t(a, r, s) : void 0;
        },
      });
    },
    function(t, n, r) {
        ...
        function M(t, n) {
          ...
          if (e === r) {
            if (((n.delegate = null), 'throw' === n.method)) {
              if (
                t.iterator.return &&
                ((n.method = 'return'), (n.arg = r), M(t, n), 'throw' === n.method)
              )
                return d;
              (n.method = 'throw'),
    ...
    function(t, n, r) {
      r(327), (t.exports = r(18).RegExp.escape);
    },
    function(t, n, r) {
      var e = r(0),
        i = r(328)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
    ...
    function(t, n, r) {
      ...
      function o(t, n, r, e, i, o, u) {
        ...
        c.done ? n(f) : Promise.resolve(f).then(e, i);
      }
      function u(t) {
        return function() {
          var n = this,
      ...
      function a() {
        return (a = u(
          regeneratorRuntime.mark(function t(n, r, i) {
            var o, u;
            return regeneratorRuntime.wrap(
              function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (t.next = 2), n.currentUser.getIdToken(!0);
                    case 2:
                      return (
                        (o = t.sent),
                        (u = e({ token: o }, i)),
                    ...
                    case 6:
                      return t.sent, t.abrupt('return', i.studyId);
                    case 8:
                    case 'end':
                      return t.stop();
                  }
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (e = r.locations),
                        delete r.locations,
                        (i = n.collection('study').doc(r.studyId)),
                        (t.next = 5),
                        i.set(r)
                      );
                    case 5:
                          ...
                          e.map(function(t) {
                            try {
                              var n = t.geometry,
                                r = n.coordinates;
                              return (
                                (n.coordinates = JSON.stringify(r)),
                                i
                                  .collection('location')
                                  .doc(t.locationId)
                                  .set(t)
            ...
            return regeneratorRuntime.wrap(
              function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return t.abrupt('return', c(n.collection('study').where('userId', '==', r)));
                    case 1:
                    case 'end':
                      return t.stop();
                  }
      ...
      function y(t, n) {
        return c(t.collection('study').where('surveyors', 'array-contains', n));
      }
      function g(t, n, r, e) {
      ...
      function m() {
        return (m = u(
          regeneratorRuntime.mark(function t(n, r, e, i) {
            return regeneratorRuntime.wrap(
              function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
              ...
              function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (t.prev = 0), (i = n.collection('study').doc(r)), (t.next = 4), i.get()
                      );
                    case 4:
                      if (!(o = t.sent).exists) {
                        t.next = 12;
                      ...
                      return (
                        ((u = o.data()).surveyors = u.surveyors ? u.surveyors : []),
                        u.surveyors.push(e),
                        (t.next = 11),
                        i.set(u)
                      );
                    ...
                    case 14:
                      (t.prev = 14),
                        (t.t0 = t.catch(0)),
                        console.error(
                          'failure to save surveyor "'
                            .concat(e, '" to study with id: ')
                            .concat(r, ', error: ')
                            .concat(t.t0),
                        );
                    case 17:
      ...
      r.r(n),
        r.d(n, 'saveStudyWithToken', function() {
          return f;
        }),
        r.d(n, 'saveStudy', function() {
          return s;
        }),
        r.d(n, 'getAvailableStudiesForUserId', function() {
          return h;
        }),
        r.d(n, 'getSurveysForStudy', function() {
          return p;
        }),
        r.d(n, 'getAuthorizedStudiesForEmail', function() {
          return y;
        }),
        r.d(n, 'addDataPoint', function() {
          return g;
        }),
        r.d(n, 'addUserToStudyByEmail', function() {
          return b;
        }),
        r.d(n, 'saveSurvey', function() {
          return w;
        });
    },
  ]);
