...
export const postToApi: <T>(route: string, data: any, token?: string) => Promise<T> = (
    route: string,
    data: any,
    token?: string
) =>
    extractBodyFromResponse(async () => {
...
export const putToApi: <T>(route: string, data: any) => Promise<T> = (
    route: string,
    data: any,
    token?: string
) =>
...
export const getFromApi: <T>(route: string) => Promise<T> = (route: string) =>
